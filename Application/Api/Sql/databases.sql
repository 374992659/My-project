...
CREATE TABLE  if not exists `group_subject` (
  ...
  `picture` varchar(800) DEFAULT NULL COMMENT '图片',
...
CREATE TABLE  if not exists `group_activity` (
  ...
  `picture` varchar(800) DEFAULT NULL COMMENT '图片展示',
...
CREATE TABLE if not EXISTS `subject_$city_id` (
  ...
  `picture` varchar(800) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '话题图片',

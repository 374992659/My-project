$(document).ready(function(){
    ...
    $(".regBtn").click(function(){
        ...
        var openId=localStorage.getItem("openId");
        // 数据加密
    info=['', JSON.stringify({"openId":openId,"account":numeber,"area_id":area_id,"password":password,'repassword':repassword,"apptoken":apptoken,"piccode":code,"inviter_code":qwe,"coedd":inviter_code})];
        console.log(info);
        // 加密后的数据
